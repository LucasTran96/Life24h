 ...
 *  Description: This is a class to help users add, edit, delete places in their family group.
 *  Auth: Lucas Walker
 */
...
public class PlaceAlertsDetail extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setEvent() {
        ...
        // cimg_SelectAddMap is a processing button that helps users select the type of map they want to see.
        ...
        // btn_Edit_PlaceAlert handles edit place alert to the family group's place list.
        ...
        // btn_Delete_PlaceAlert handles delete place alert to the family group's place list.
    ...
    /**
     * deletePlaceAlert(): delete place arlert in family.
     */
    ...
    /**
     * this is method save place alerts to firebase from Model fb_area
     */
            ...
            }else
            {
                ...
                if(textInputLayoutName.getEditText().getText().toString().equals(""))
                {
                    ...
                    mFirebaseDatabase.child(String.valueOf(keyInPlaceAlert))
                        ...
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(PlaceAlertsDetail.this, "Add Place Alert Successfully.", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            // Write failed
                            Toast.makeText(PlaceAlertsDetail.this, "Add Place Alert Error!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (chekcAddPlace)
        {
            ...
            if (fb_area_Place != null)
            {
                ...
                if(fb_area_Place.getRadius() >=200)
                {
                    float dpCalculation = getResources().getDisplayMetrics().density;
                    int height = 200 + fb_area_Place.getRadius()/10;
        ...
        // This is method help user move camera and select location of Place Alert
