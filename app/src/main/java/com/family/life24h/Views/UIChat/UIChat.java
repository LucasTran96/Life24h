...
import com.family.life24h.Adapter.aRclvChat;
import com.family.life24h.Adapter.aRclvUploadImageMsg;
...
public class UIChat extends AppCompatActivity implements view_Chat {
    ...
    private void showDialogSelectSendImage(){
        ...
        TextView tvUploadPhoto = (TextView) dialog.findViewById(R.id.tvUploadPhoto);
