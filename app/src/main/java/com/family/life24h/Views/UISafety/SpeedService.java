...
import com.family.life24h.Views.DetectActivitys.DetectedActivitiesIntentService;
...
import static com.family.life24h.Utils.keyUtils.MIN_SPEED_AVERAGE;
import static com.family.life24h.Utils.keyUtils.LOWEST_SPEED_TO_WARN;
import static com.family.life24h.Utils.keyUtils.NETWORK;
import static com.family.life24h.Utils.keyUtils.THE_FASTEST_SPEED_TO_WARN;
...
//                mRef.child("time").setValue(currentSpeed);
                ...
                if(isWarning){
                    ...
                    pre_Safety.sendEmergencyAssistanceAbnormalSpeed(context, new pre_Safety.iEmergencyAssistanceAbnormalSpeed() {
                        @Override
                        public void onResult(boolean isSuccess, String message) {
                            if(isSuccess)
                                Toast.makeText(context, R.string.Emergency_notification_sent_successfully, Toast.LENGTH_SHORT).show();
                            else{
                                Log.e(TAG,message);
                                Toast.makeText(context, R.string.Notice_of_failure, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
