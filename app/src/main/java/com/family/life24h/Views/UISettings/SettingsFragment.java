...
import static com.family.life24h.Utils.viewUtils.rateApp;
...
//        lnlUpgradePremium.setVisibility(mAccount.isBought() ? View.GONE : View.VISIBLE);
//        lnlUpgradePremium.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intentSubscriptions = new Intent(getContext(), UIUpgradePremium.class);
//                startActivity(intentSubscriptions);
//            }
//        });

        lnlRateApp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rateApp(getContext());
            }
    ...
    private void initView() {
        ...
        lnlUpgradePremium = viewParent.findViewById(R.id.lnlUpgradePremium);
        lnlRateApp = viewParent.findViewById(R.id.lnlRateApp);
